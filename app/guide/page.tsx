...
export const metadata: Metadata = {
  title: "Student Guide",
  description:
    "Open the ENGG2202 Notion guide for Checkpoint tasks, methods, resources, templates and checkpoint instructions.",
...
const guideContents = [
  ["01", "Checkpoint task", "The decision your team needs to make and the evidence required before review."],
  ...
  ["04", "Checkpoint instructions", "The exact submission format for the Checkpoint, with links to the relevant course platform."],
];
          ...
          <div className="mx-auto grid max-w-[90rem] gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-5 text-5xl font-semibold leading-[0.98] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
                Detailed help
                <span className="block text-[#d7f43c]">for the Checkpoint you are working on.</span>
              </h1>
            </div>
            <div className="max-w-2xl lg:justify-self-end">
              <p className="text-lg leading-9 text-white/78">
                The Develop page explains the six Checkpoints. The Notion guide provides the working materials for completing them.
              </p>
        ...
        <section id="engineering-compass" className="scroll-mt-20 border-b border-[#d7e4d9] bg-[#eef6ec] px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
          <div className="mx-auto grid max-w-[90rem] overflow-hidden rounded-[2rem] border border-[#cadbcd] bg-white shadow-[0_30px_80px_-58px_rgba(15,60,32,0.5)] lg:grid-cols-[0.92fr_1.08fr]">
            <div className="p-7 sm:p-10 lg:p-12">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#57745e]">Before Checkpoint 01 · optional self-reflection</p>
        ...
        <section className="mx-auto max-w-[90rem] px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          <div className="grid gap-8 lg:grid-cols-[0.62fr_1.38fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.04em] text-[#143421]">Open the page for your current Checkpoint.</h2>
        ...
        <section className="border-y border-[#d7e4d9] bg-[#eef6ec] px-5 py-14 sm:px-8 lg:px-10">
          <div className="mx-auto grid max-w-[90rem] gap-4 md:grid-cols-3">
            <Link href="/engg2202" className="group rounded-[1.7rem] border border-[#d1dfd3] bg-white p-7">
              ...
              <h2 className="mt-4 text-2xl font-semibold text-[#173823]">Return to project development.</h2>
              <span className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#226439]">View all six Checkpoints <ArrowIcon /></span>
            </Link>
            <a href={notionGuideUrl} target="_blank" rel="noopener noreferrer" className="group rounded-[1.7rem] bg-[#153f27] p-7 text-white">
              ...
              <span className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#d7f43c]">Choose your Checkpoint <ArrowIcon /></span>
            </a>
